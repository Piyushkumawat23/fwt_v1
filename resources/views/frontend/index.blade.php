        ...
        <div class="service-area section-padding40">
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-xl-10 col-lg-7 col-md-10 col-sm-10">
                        <!-- Section Tittle -->
                        <div class="section-tittle text-center mb-80">
                            <span>What we are doing</span>
                            <h2>Dedicated To Reviving Traditional Crafts And Empowering Skilled Hands</h2>
                        </div>
                    </div>
                </div>
                <div class="row">
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        <div class="single-team mb-30">
                            <div class="team-img">
                                <img src="{{ asset('public/assets/frontend/img/gallery/fwt1.jpg') }} " alt="Profile">
