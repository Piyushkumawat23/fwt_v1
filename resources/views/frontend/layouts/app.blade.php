...
<head>
    ...
    <link rel="shortcut icon" type="image/x-icon" href="{{ asset('public/assets/frontend/img/logo/logo6.png') }}">
        ...
        <div class="preloader d-flex align-items-center justify-content-center">
            <div class="preloader-inner position-relative">
                ...
                <div class="preloader-img pere-text">
                    <img src="{{ asset('public/assets/frontend/img/logo/loder2.jpg') }} " alt="Profile">
                </div>
            </div>
        </div>
    </div>
                        ...
                        <div class="row d-flex justify-content-between align-items-center">
                            <div class="col-xl-10 col-lg-9 ">
                                <div class="footer-copy-right">
                                    <p>
                                        <!-- Link back to HFS can't be removed. Template is licensed under CC BY 3.0. -->
                                        Copyright &copy;<script>
                                        document.write(new Date().getFullYear());
                                        </script> All rights reserved | This template is made with <i
                                            class="fa fa-heart" aria-hidden="true"></i> by <a
                                            href="https://HFS.com" target="_blank">HFS</a>
                                        <!-- Link back to HFS can't be removed. Template is licensed under CC BY 3.0. -->
                                    </p>
                                </div>
                            </div>
